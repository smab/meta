...
# -*- coding: utf-8 -*-
#
# Playhouse documentation build configuration file, created by
# sphinx-quickstart on Sun May 11 17:37:44 2014.
#
...
htmlhelp_basename = 'playhousedoc'
...
man_pages = [
    ('index', 'Playhouse', 'Playhouse Documentation',
     ['John Eriksson, Arvid Fahlström Myrman, Jonas Höglund, Hannes Leskelä, Christian Lidström, Mattias Palo, Markus Videll, Tomas Wickman, Emil Öhman'], 1)
]
...
texinfo_documents = [
  ('index', 'Playhouse', 'Playhouse Documentation',
   'John Eriksson, Arvid Fahlström Myrman, Jonas Höglund, Hannes Leskelä, Christian Lidström, Mattias Palo, Markus Videll, Tomas Wickman, Emil Öhman', 'playhouse', 'One line description of project.',
   'Miscellaneous'),
]
